...
CALIBRATION_NODE_NAME = 'mraysu_node'
...
#
        ...
        # TODO: simplify, make it so that only one bounding box is created, make bound a circle instead
        ...
        color_config_path = str('/home/projects/ros2_ws/src/mraysu_object_detection2_pkg/config/ros_racer_calibration.yaml')
